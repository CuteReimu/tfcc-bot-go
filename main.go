...
func writeConfig() {
	...
	config.GlobalConfig.Set("schedule.speedrun_push_delay", int64(300))
	config.GlobalConfig.Set("schedule.speedrun_push_qq_group", []int64{12345678})
	config.GlobalConfig.Set("schedule.speedrun_api_key", "abcdefghijk")
